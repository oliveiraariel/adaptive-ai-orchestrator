    ...
    def _build_replan_prompt(
        ...
        *,
        ...
        return (
            ...
            "exhausted their bounded attempts. Return the full plan, preserving every "
            ...
            "- RECOVERY_REQUIRED means distinct worker strategies were already exhausted; do not merely schedule the same Work Unit again unchanged.\n"
            "- When local remediation, diagnosis, or prerequisite work can unblock a RECOVERY_REQUIRED Work Unit, add the smallest bounded new Work Unit(s) and add a required dependency from that recovery Work Unit into the original RECOVERY_REQUIRED Work Unit (new-remediation -> original-recovery-unit).\n"
    ...
    def _build_replan_recovery_prompt(
        ...
        *,
        ...
        return (
            ...
            "one concrete remediation or diagnostic prerequisite and connect it as "
