    ...
    def _build_replan_prompt(
        ...
        *,
        ...
        return (
            ...
            "- When local remediation, diagnosis, corrected scope discovery, or prerequisite work can unblock a RECOVERY_REQUIRED Work Unit, add the smallest bounded new Work Unit(s) and add a required dependency from that recovery Work Unit into the original RECOVERY_REQUIRED Work Unit (new-remediation -> original-recovery-unit).\n"
